  ...
  return (
    <>
      ...
      {editor && (
        ...
        >
          <button className="flex items-center gap-1 p-1 rounded min-w-[280px] h-[60px] hover:bg-zinc-600">
            <img
          ...
          <button
            className="flex items-center gap-1 p-1 rounded min-w-[280px] h-[60px] hover:bg-zinc-600"
            onClick={() =>
          ...
          >
            ...
            />
            <div className="flex flex-col text-left">
              <span className="text-sm text-zinc-100">Heading 2</span>
              <span className="text-xs text-zinc-400">
